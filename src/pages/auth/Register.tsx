...
import { UserPlus, Eye, EyeOff, AlertCircle, Loader } from 'lucide-react'
      ...
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <p className="mt-2 text-base text-gray-600 font-light">
            Join thousands of professionals mastering communication
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                />
                {errors.firstName && (
                  <p className="mt-2 text-sm text-red-500 font-light">{errors.firstName.message}</p>
                )}
              </div>
              ...
              <div>
                ...
                />
                {errors.lastName && (
                  <p className="mt-2 text-sm text-red-500 font-light">{errors.lastName.message}</p>
                )}
              </div>
            </div>
            ...
            <div>
              ...
              {errors.confirmPassword && (
                <p className="mt-2 text-sm text-red-500 font-light">{errors.confirmPassword.message}</p>
              )}
            </div>
            ...
            <div className="flex items-start">
              ...
              />
              <label htmlFor="terms" className="ml-3 block text-sm text-gray-700 font-light">
                I agree to the{' '}
